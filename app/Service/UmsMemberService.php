...
class UmsMemberService extends Service implements UmsMemberServiceInterface
{
    /**
     * @Inject()
     * @var JWT
    ...
    private function loadUserByUsername(string $username) : UmsMember
    {
    ...
    private function getByUsername(string $username) : ?UmsMember
    {
