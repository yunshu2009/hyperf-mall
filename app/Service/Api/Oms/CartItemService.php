...
class CartItemService  extends Service implements CartItemServiceInterface
{
    /**
     * @Inject()
     * @var \App\Service\Api\Pms\ProductServiceInterface
     */
    private $pmsProductService;

    /**
     * @Inject()
     * @var \App\Service\Api\Pms\SkuStockServiceInterface
     */
    ...
    /**
     * @Inject()
     * @var \App\Service\Api\Sms\PromotionServiceInterface $promotionService;
     *
     * @return array
     */
    ...
    public function getCartItem(array $cartItem) :object
    {
